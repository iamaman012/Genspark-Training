select * from Employees1
 ...
 sp_help Employees1
 -- creataing a index 
create index idxEmpEmail on Employees1(email)

select * from employees1 where email like 'r%'
...
create proc proc_GreetWith(@cname varchar(20))
as
begin
   print 'Hello '+@cname
end

exec proc_GreetWith 'Ramu'
...
exec proc_PrintDetails 'Ramu',23,'8877665544'
