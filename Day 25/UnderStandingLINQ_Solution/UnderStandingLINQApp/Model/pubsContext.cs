...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=71RBBX3\\SQLEXPRESS;Integrated Security=true;Initial Catalog=pubs");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Discount>(entity =>
            {
                ...
                entity.HasOne(d => d.Stor)
                    ...
                    .HasConstraintName("FK__discounts__stor___619B8048");
            });
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasOne(d => d.Job)
                    ...
                    .HasConstraintName("FK__employee__job_id__6E01572D");

                entity.HasOne(d => d.Pub)
                    .WithMany(p => p.Employees)
                    .HasForeignKey(d => d.PubId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__employee__pub_id__70DDC3D8");
            });
            ...
            modelBuilder.Entity<PubInfo>(entity =>
            {
                ...
                entity.HasOne(d => d.Pub)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__pub_info__pub_id__693CA210");
            });
            ...
            modelBuilder.Entity<Roysched>(entity =>
            {
                ...
                entity.HasOne(d => d.Title)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__roysched__title___5FB337D6");
            });
            ...
            modelBuilder.Entity<Sale>(entity =>
            {
                ...
                entity.HasOne(d => d.Stor)
                    ...
                    .HasForeignKey(d => d.StorId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__sales__stor_id__5CD6CB2B");

                entity.HasOne(d => d.Title)
                    .WithMany(p => p.Sales)
                    .HasForeignKey(d => d.TitleId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__sales__title_id__5DCAEF64");
            });
            ...
            modelBuilder.Entity<Title>(entity =>
            {
                ...
                entity.HasOne(d => d.Pub)
                    .WithMany(p => p.Titles)
                    .HasForeignKey(d => d.PubId)
                    .HasConstraintName("FK__titles__pub_id__534D60F1");
            });
            ...
            modelBuilder.Entity<Titleauthor>(entity =>
            {
                ...
                entity.HasOne(d => d.Au)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__titleauth__au_id__571DF1D5");

                entity.HasOne(d => d.Title)
                    .WithMany(p => p.Titleauthors)
                    .HasForeignKey(d => d.TitleId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__titleauth__title__5812160E");
            });
